package com.yewanlong.model.Realm;
...
public class RealmHelper {
    ...
    public static ArrayList<God> selector(Context context){
...
//        RealmQuery<God> godRealmQuery = realmQuery.equalTo("godType", godType);
        ...
        if (realmQuery != null && realmResults.size() > 0) {
...
//        RealmQuery<God> godRealmQuery = realmQuery.equalTo("godType", god.getGodType());
        RealmResults<God> realmResults = realm.where(God.class).findAll();
