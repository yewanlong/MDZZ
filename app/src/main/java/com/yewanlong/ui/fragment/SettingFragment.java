...
import com.yewanlong.presenter.impl.SettingFImpl;
import com.yewanlong.ui.activity.SettingActivity;
import com.yewanlong.ui.adapter.ColorListAdapter;
...
public class SettingFragment extends PreferenceFragment implements SettingAView {
    ...
    public void showChangeThemeDialog() {
        ...
        int value = (int) SPUtils.get(getActivity().getResources().getString(R.string.change_theme_key), 1);
