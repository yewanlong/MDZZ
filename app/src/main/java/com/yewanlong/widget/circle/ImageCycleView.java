package com.yewanlong.widget.circle;
...
public class ImageCycleView extends LinearLayout {
	...
	public void setImageResources(ArrayList<String> imageDesList,ArrayList<String> imageUrlList,ImageCycleViewListener imageCycleViewListener) {
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
				mImageViews[i].setBackgroundResource(R.drawable.a2);
			} else {
				mImageViews[i].setBackgroundResource(R.drawable.a1);
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			// 设置图片滚动指示器背
			mImageViews[index].setBackgroundResource(R.drawable.a2);
