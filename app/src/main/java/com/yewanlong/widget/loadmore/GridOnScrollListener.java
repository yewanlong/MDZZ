package com.yewanlong.widget.loadmore;
...
public abstract class GridOnScrollListener extends RecyclerView.OnScrollListener {
    ...
    public static String TAG = GridOnScrollListener.class.getSimpleName();
    ...
    public GridOnScrollListener(GridLayoutManager linearLayoutManager) {
